    ...
    return (
        ...
        >
            <button className='flex flex-col justify-center items-center hidden lg:flex' onClick={handleClick}>
                ...
                <span className={`bg-dark dark:bg-light block h-0.5 w-6 rounded-sm my-0.5 transition-all duration-300 ease-out ${isOpen ? 'opacity-0' : 'opacity-100'}`}></span>
                <span className={`bg-dark dark:bg-light block h-0.5 w-6 rounded-sm transition-all duration-300 ease-out ${isOpen ? '-rotate-45 -translate-y-1' : 'translate-y-0.5'}`}></span>
            </button>
            ...
            <nav className="flex items-center justify-center flex-wrap mt-2">
                ...
                <motion.a href="https://twitter.com" target={"_blank"} className="w-6 mx-3 bg-light dark:bg-dark rounded-full sm:mx-1"
                    whileHover={{y:-2}} 
                    whileTap={{sacle:0.9}}
                     ><GithubIcon />
                     </motion.a>
